...
const howItWorks = [
  ...
  },
  {
    step: 3,
    title: "Contrate",
    desc: "Defina datas, frequência de visitas e forma de pagamento",
  },
  {
    step: 4,
    title: "Relaxe",
      ...
      <div className="flex flex-1 flex-col gap-0 p-6">
        <div className="mb-4 flex items-start gap-4">
          <div className="relative shrink-0">
            <div className="h-16 w-16 overflow-hidden rounded-full border-2 border-[#DCFCE7]">
              <img
                src={pro.image}
                alt={pro.name}
            ...
            <div className="absolute bottom-0 right-0 flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-[#2B7FFF]">
              <VerifiedIcon />
            </div>
          </div>

          <div className="min-w-0 flex-1">
            <h3 className="text-lg font-bold leading-7 tracking-[-0.44px] text-app-dark">
              {pro.name}
            </h3>

            <p className="mt-0.5 text-sm leading-5 tracking-[-0.15px] text-app-gray">
              {pro.title}
            </p>
            ...
            <div className="mt-1 flex items-center gap-1">
              ...
              <span className="text-base font-semibold leading-6 tracking-[-0.31px] text-app-dark">
                {pro.rating}
              </span>

              <span className="text-sm leading-5 tracking-[-0.15px] text-app-gray2">
        ...
        <p className="mb-4 line-clamp-3 text-sm leading-5 tracking-[-0.15px] text-app-gray">
          {pro.bio}
        </p>
        ...
        <div className="mb-5 flex flex-wrap gap-2">
          {pro.tags.map((tag) => (
            <span
              key={tag}
              className="rounded-full bg-[#F0FDF4] px-3 py-1 text-xs font-medium leading-4 text-[#008236]"
            >
              {tag}
            </span>
          ))}
        ...
        <div className="mb-4 flex items-center gap-4 border-b border-[#F3F4F6] pb-4">
          <div className="flex items-center gap-2">
            <BadgeIcon />

            <span className="text-sm leading-5 tracking-[-0.15px] text-app-gray">
              {pro.jobs} trabalhos
            </span>
          </div>
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="flex flex-col items-end">
            <span className="text-2xl font-bold leading-8 tracking-[0.07px] text-app-dark">
              R$ {pro.price}
            </span>

            <span className="text-xs leading-4 text-app-gray2">
              por visita
            </span>
          </div>
        </div>
        ...
        <div className="mb-4">
          {pro.available ? (
            <span className="inline-flex rounded-full bg-[#DCFCE7] px-3 py-1 text-xs font-medium leading-4 text-[#008236]">
              Disponível
            </span>
          ) : (
            <span className="inline-flex rounded-full bg-[#FEF9C2] px-3 py-1 text-xs font-medium leading-4 text-[#A65F00]">
              {pro.busyUntil}
            </span>
          )}
        </div>
        ...
        <div className="mt-auto flex gap-2">
          ...
          <Link
            to="/prestador/perfil"
            className="flex-1 rounded-[10px] border-2 border-[#D1D5DC] bg-white py-3 text-center text-sm font-medium leading-5 tracking-[-0.15px] text-[#364153] transition-colors hover:bg-gray-50"
          >
            Ver Perfil
          </Link>
        </div>
  ...
  return (
    <div className="flex min-h-screen flex-col font-inter">
      ...
      <main className="flex-1">
        <section className="border-b border-[#E5E7EB] bg-gradient-to-br from-[#F0FDF4] to-[#ECFDF5]">
          <div className="mx-auto flex max-w-[1143px] flex-col items-center gap-8 px-4 py-16 sm:px-8">
            <div className="flex max-w-3xl flex-col items-center gap-4 text-center">
              <h1 className="text-4xl font-bold leading-tight tracking-[0.35px] text-app-dark sm:text-5xl">
                Encontre o Profissional Ideal
              </h1>

              <p className="max-w-[739px] text-lg leading-7 tracking-[-0.45px] text-[#4A5565] sm:text-xl">
                Escolha entre diversos especialistas em plantas e contrate
                diretamente quem melhor atende suas necessidades.
              </p>
            </div>
            ...
            <div className="flex w-full max-w-[768px] items-center gap-2 rounded-[14px] bg-white px-4 py-2 shadow-lg">
              ...
              <button className="shrink-0 rounded-[10px] bg-brand px-6 py-3 text-base font-medium leading-6 tracking-[-0.31px] text-white transition-colors hover:bg-brand-dark">
                Buscar
              </button>
            </div>
          </div>
        ...
        <section className="bg-[#F9FAFB]">
          <div className="mx-auto flex max-w-[1143px] flex-col gap-8 px-4 py-8 sm:px-8">
            <div className="flex items-center justify-between rounded-[10px] bg-white px-4 py-4 shadow-sm">
              <div className="flex items-center gap-3">
                <select className="cursor-pointer rounded-md border border-[#D1D5DC] px-3 py-1.5 text-sm text-[#364153] outline-none">
        ...
        <section className="bg-white">
          <div className="mx-auto flex max-w-[1143px] flex-col gap-16 px-4 py-20 sm:px-8">
            <div className="flex flex-col items-center gap-4 text-center">
              <h2 className="text-3xl font-bold leading-10 tracking-[0.37px] text-app-dark sm:text-4xl">
                Como Funciona
              </h2>

              <p className="text-lg leading-7 tracking-[-0.44px] text-[#4A5565]">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {howItWorks.map((item) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold leading-7 tracking-[-0.45px] text-app-dark">
                    {item.title}
                  </h3>

                  <p className="text-base leading-6 tracking-[-0.31px] text-[#4A5565]">
                    {item.desc}
                  </p>
                </div>
              ))}
        ...
        <section className="bg-white px-4 pb-16 sm:px-8">
          <div className="mx-auto flex max-w-[896px] flex-col items-center gap-5 rounded-2xl bg-brand px-6 py-12 text-center sm:px-12">
            <h2 className="text-3xl font-bold leading-10 tracking-[0.37px] text-white sm:text-4xl">
              Você é Profissional de Plantas?
            </h2>

            <p className="max-w-[742px] text-lg leading-7 tracking-[-0.45px] text-[#F0FDF4] sm:text-xl">
              Cadastre-se em nossa plataforma e comece a oferecer seus serviços
              hoje mesmo
            </p>
